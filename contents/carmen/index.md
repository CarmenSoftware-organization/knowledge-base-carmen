...
![Statistical Highlight](./dashboard/01-statistical-highlight.png)
...
1. Click ที่ปุ่ม ![ปุ่มตั้งค่า](./dashboard/settings-menu-icon.png) ด้านหลังของ Dashboard
2. กำหนดข้อมูลดังต่อไปนี้

![การตั้งค่า Statistical Highlight](./dashboard/02-statistical-highlight-settings.png)
...
![Dimension Analysis](./dashboard/03-dimension-analysis.png)
...
![การตั้งค่า Dimension Analysis](./dashboard/04-dimension-analysis-settings.png)
...
![This Year VS Last Year](./dashboard/05-this-year-vs-last-year.png)
...
![การตั้งค่า This Year VS Last Year](./dashboard/06-this-year-vs-last-year-settings.png)
...
![Monthly P&L Summary](./dashboard/07-monthly-pl-summary.png)
...
![Daily Monitor Account](./dashboard/08-daily-monitor-account.png)
...
![การตั้งค่า Daily Monitor Account](./dashboard/09-daily-monitor-account-settings.png)
