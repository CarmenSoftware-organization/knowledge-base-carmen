...
![](../kb/_images/8.Physical Count ไม่เจอStore ที่ต้องการนับ/img-001.png)  
...
![](../kb/_images/8.Physical Count ไม่เจอStore ที่ต้องการนับ/img-002.png)  
...
![](../kb/_images/8.Physical Count ไม่เจอStore ที่ต้องการนับ/img-003.png)![](../kb/_images/8.Physical Count ไม่เจอStore ที่ต้องการนับ/img-004.png)  
กด Create อีกครั้ง จะปรากฏ Store IT ขึ้นมาเรียบร้อย ดำเนินการ Physical Count ได้ตามปกติ  
![](../kb/_images/8.Physical Count ไม่เจอStore ที่ต้องการนับ/img-005.png)  
Tag:   
Related topics:
