...
![](../kb/_images/9.Receiving Manually เลือก Store แล้วมองไม่เห็น Product/img-001.png)   
Solution: ไปที่ Product ทำการ กดปุ่ม Assign เลือก Store ที่ต้องการ ทำการติ๊กถูกที่ Store และทำการกด Save  
![](../kb/_images/9.Receiving Manually เลือก Store แล้วมองไม่เห็น Product/img-002.png)  
![](../kb/_images/9.Receiving Manually เลือก Store แล้วมองไม่เห็น Product/img-003.png)  
กลับไปที่เอกสาร Receiving Manuanlly ก็จะพบ Product ปรากฏขึ้นมาให้ทำรายการตามปกติ  
![](../kb/_images/9.Receiving Manually เลือก Store แล้วมองไม่เห็น Product/img-004.png)  
Tag:   
Related topics:
