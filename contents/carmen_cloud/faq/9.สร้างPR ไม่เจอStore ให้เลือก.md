...
![](../kb/_images/9.สร้างPR ไม่เจอStore ให้เลือก/img-001.png)  
...
2\.Administrator  
3\.User  
![](../kb/_images/9.สร้างPR ไม่เจอStore ให้เลือก/img-002.png)  
4\.คลิก User ที่ติดปัญหา จากตัวอย่าง คือ User: Support   
![](../kb/_images/9.สร้างPR ไม่เจอStore ให้เลือก/img-003.png)  
...
6\.กดปุ่ม Edit  
![](../kb/_images/9.สร้างPR ไม่เจอStore ให้เลือก/img-004.png)  
7\.เลือก Store A&G\-Accounting   
8\.กด Save   
![](../kb/_images/9.สร้างPR ไม่เจอStore ให้เลือก/img-005.png)  
  
กลับมาที่เอกสาร PR ก็จะพบ Store A&G\-Accounting ให้คลิกเลือกแล้วครับ ตามรูปภาพด้านล่าง  
![](../kb/_images/9.สร้างPR ไม่เจอStore ให้เลือก/img-006.png)  
Tag:   
Related topics:
