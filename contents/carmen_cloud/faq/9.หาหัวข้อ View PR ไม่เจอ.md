...
Cause of Problems: User ที่ติดปัญหา ไม่ได้ถูก Assign เอาไว้ที่หัวข้อ Step Approved By HOD ใน Workflow Configuration ส่วนของ Purchase Request ![](../kb/_images/9.หาหัวข้อ View PR ไม่เจอ/img-001.png) ![](../kb/_images/9.หาหัวข้อ View PR ไม่เจอ/img-002.png)  
...
7\.กด Save  
![](../kb/_images/9.หาหัวข้อ View PR ไม่เจอ/img-005.png)  
...
![](../kb/_images/9.หาหัวข้อ View PR ไม่เจอ/img-006.png)  
Tag:   
Related topics:
