...
![](../kb/_images/7.Receiving ผิด Store จะปรับปรุงข้อมูลอย่างไร/img-001.png)  
...
1\.4\.เลือกจำนวน Qty ของรายการ![](../kb/_images/7.Receiving ผิด Store จะปรับปรุงข้อมูลอย่างไร/img-002.png)  
...
![](../kb/_images/7.Receiving ผิด Store จะปรับปรุงข้อมูลอย่างไร/img-003.png)  
2\.Stock in\-out 

2\.1\.ทำ Stock Out ออกจาก Store  Housekeeping เพื่อตัดของออกให้ถูกต้อง  
![](../kb/_images/7.Receiving ผิด Store จะปรับปรุงข้อมูลอย่างไร/img-004.png)  
2\.2\.ทำ Stock IN เข้าที่ Store IT เพื่อเพิ่มของเข้าไปที่Store ที่ถูกต้อง  
![](../kb/_images/7.Receiving ผิด Store จะปรับปรุงข้อมูลอย่างไร/img-005.png)  
