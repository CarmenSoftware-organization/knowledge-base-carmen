...
จากตัวอย่างคือ จะแสดงแต่ละ module ว่าเป็น Period ใดบ้าง เช่น AP ตอนนี้คือ 30/04/2024 เป็นต้น![](../kb/_images/8. วิธีตรวจสอบ Current Period ของ module ใน Carmen/img-001.png)  
Tag:   
Related topics:
