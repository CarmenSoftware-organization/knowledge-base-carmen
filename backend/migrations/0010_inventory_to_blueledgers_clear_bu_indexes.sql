-- One-time: DB ที่เคยมี schema inventory → ตัดทิ้ง สร้าง blueledgers ล้าง wiki index carmen+blueledgers

BEGIN;

DROP SCHEMA IF EXISTS inventory CASCADE;

DELETE FROM public.business_units WHERE slug = 'inventory';
...
TRUNCATE TABLE blueledgers.documents RESTART IDENTITY CASCADE;
