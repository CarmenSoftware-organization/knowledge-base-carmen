(function(M,T){typeof exports=="object"&&typeof module<"u"?T(exports):typeof define=="function"&&define.amd?define(["exports"],T):(M=typeof globalThis<"u"?globalThis:M||self,T(M.CarmenBot={}))})(this,(function(M){"use strict";class T{constructor(t){this.baseUrl=t.replace(/\/$/,""),this.ROOMS_KEY="carmen_rooms"}async getRooms(t,e){try{const o=localStorage.getItem(this.ROOMS_KEY);return o?JSON.parse(o):[]}catch(o){return console.warn("getRooms Error:",o),[]}}async createRoom(t,e,o="บทสนทนาใหม่"){const n={room_id:"loc_"+Math.random().toString(36).substring(2,10),title:o||"บทสนทนาใหม่",updated_at:new Date().toISOString()};try{const r=await this.getRooms();return r.unshift(n),localStorage.setItem(this.ROOMS_KEY,JSON.stringify(r)),n}catch(r){return console.error("createRoom Error:",r),n}}async getRoomHistory(t){try{if(!t)return{messages:[]};const e=localStorage.getItem(`carmen_history_${t}`);return e?JSON.parse(e):{messages:[]}}catch(e){return console.warn("getRoomHistory Error:",e),{messages:[]}}}async _pruneOldestRoom(){try{const t=await this.getRooms();if(t.length===0)return!1;const e=t.pop();return localStorage.setItem(this.ROOMS_KEY,JSON.stringify(t)),localStorage.removeItem(`carmen_history_${e.room_id}`),!0}catch(t){return console.error("Prune error",t),!1}}async saveMessage(t,e){if(!t||!e)return;let o=!1,i=0;const n=10;for(;!o&&i<n;)try{const r=await this.getRoomHistory(t);r.messages.push(e),localStorage.setItem(`carmen_history_${t}`,JSON.stringify(r));const a=await this.getRooms(),p=a.findIndex(d=>d.room_id===t);if(p!==-1){const d=a.splice(p,1)[0];d.updated_at=new Date().toISOString(),a.unshift(d),localStorage.setItem(this.ROOMS_KEY,JSON.stringify(a))}o=!0}catch(r){if(r.name==="QuotaExceededError"||r.name==="NS_ERROR_DOM_QUOTA_REACHED"){if(console.warn(`LocalStorage is full. Auto-pruning oldest room (Attempt ${i+1})...`),!await this._pruneOldestRoom()){console.error("LocalStorage full and cannot prune any more rooms.");break}i++}else{console.warn("saveMessage Error:",r);break}}}async deleteRoom(t){try{if(!t)return{status:"success"};const o=(await this.getRooms()).filter(i=>i.room_id!==t);return localStorage.setItem(this.ROOMS_KEY,JSON.stringify(o)),localStorage.removeItem(`carmen_history_${t}`),await this.clearHistory(t),{status:"success"}}catch(e){return console.error("deleteRoom Error:",e),{status:"error"}}}async sendMessage(t){const e=await fetch(`${this.baseUrl}/api/chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)});if(!e.ok){let o="Unknown Error";try{const i=await e.json();o=i.detail||JSON.stringify(i)}catch{o=await e.text()}throw new Error(`API Error ${e.status}: ${o}`)}return await e.json()}async sendFeedback(t,e){try{await fetch(`${this.baseUrl}/api/chat/feedback/${t}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({score:e})})}catch(o){console.error("Feedback Error:",o)}}async clearHistory(t){try{if(!t)return;await fetch(`${this.baseUrl}/api/chat/clear/${t}`,{method:"DELETE"})}catch(e){console.warn("ClearHistory API Error:",e)}}async getHistory(t,e,o){try{const i=new URLSearchParams({bu:t,username:e,session_id:o||""}),n=await fetch(`${this.baseUrl}/chat/history?${i.toString()}`);return n.ok?await n.json():[]}catch(i){return console.warn("Legacy getHistory Error:",i),[]}}}function D(s="#34558b"){return`
    ...
    *:hover::-webkit-scrollbar-thumb { background: rgba(0,0,0,0.2) !important; }
    ...
    `}const Y=Object.freeze(Object.defineProperty({__proto__:null,createMessageExtras:I,createRoomItemHTML:B,createTooltipHTML:H,createTypingIndicatorHTML:R,createWidgetHTML:z},Symbol.toStringTag,{value:"Module"}));function O(s){if(!s)return null;try{const t=/(?:youtube\.com\/(?:[^\/]+\/.+\/|(?:v|e(?:mbed)?)\/|.*[?&]v=)|youtu\.be\/)([^"&?\/\s]{11})/i,e=s.match(t);return e?e[1]:null}catch{return null}}function F(s){const t=/\[(.*?)\]\((https?:\/\/(?:www\.)?(?:youtube\.com|youtu\.be)[^\s<)"']+)\)/g;s=s.replace(t,(o,i,n)=>{const r=O(n);return r?`<div class="carmen-processed-video" style="margin:8px 0; border-radius:10px; overflow:hidden; position:relative; width:100%; padding-bottom:56.25%; height:0;"><iframe src="https://www.youtube.com/embed/${r}" style="position:absolute; top:0; left:0; width:100%; height:100%; border:none; border-radius:10px;" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div>`:o});const e=/(https?:\/\/(?:www\.)?(?:youtube\.com|youtu\.be)[^\s<)"']+)/g;return s=s.replace(e,(o,i,n,r)=>{const a=r.substring(Math.max(0,n-10),n);if(/src=['"]$|href=['"]$|\($/.test(a)||r.substring(Math.max(0,n-100),n).includes("carmen-processed-video"))return o;const d=O(o);return d?`<div class="carmen-processed-video" style="margin:8px 0; border-radius:10px; overflow:hidden; position:relative; width:100%; padding-bottom:56.25%; height:0;"><iframe src="https://www.youtube.com/embed/${d}" style="position:absolute; top:0; left:0; width:100%; height:100%; border:none; border-radius:10px;" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div>`:o}),s}function P(s,t){const e=o=>{let i=o.trim().replace(/\\/g,"/");if(i.includes("youtube.com")||i.includes("youtu.be")||i.startsWith("data:"))return i;const n=r=>{let a=r.replace(/^https?:\/\/[^\/]+/,"").split("?")[0];return a=a.replace(/^\/images\//,"").replace(/^\.\//,"").replace(/^\/+/,""),a.replace(/^carmen_cloud\//,"")};if(/^(http|https):/.test(i)){if(!(i.includes("127.0.0.1")||i.includes("localhost")||t&&i.startsWith(t))){const a=i.split("/images/");if(a.length>1)return`${t}/images/${a[1]}`;const p=n(i);return`${t}/images/${p}`}return i.includes("/images/")?i:`${t}/images/${n(i)}`}return`${t}/images/${n(i)}`};return s=s.replace(/!\[(.*?)\]\((.*?)\)/g,(o,i,n)=>{if(n.includes("youtube.com")||n.includes("youtu.be"))return o;const r=e(n);return`<br><a href="${r}" target="_blank"><img src="${r}" alt="${i}" class="carmen-processed-img"></a><br>`}),s=s.replace(/<img\s+[^>]*src=["']([^"']+)["'][^>]*>/gi,(o,i)=>{if(o.includes("carmen-processed-img")||i.includes("youtube"))return o;const n=e(i);return`<br><a href="${n}" target="_blank"><img src="${n}" class="carmen-processed-img"></a><br>`}),s=s.replace(/(?:^|[\s>])(?:ดูรูป\s*)?`?((?:[\w\-\u2010\u2011\u2012\u2013]+\/)*[\w\-\u2010\u2011\u2012\u2013]+\.(?:png|jpg|jpeg|gif|svg|webp))`?/gi,(o,i)=>{const r=i.replace(/[\u2010\u2011\u2012\u2013\u2014]/g,"-").replace(/^carmen_cloud\//,""),a=`${t}/images/${r}`;return`<br><a href="${a}" target="_blank"><img src="${a}" alt="${r}" class="carmen-processed-img"></a><br>`}),s=s.replace(/<img[^>]*$/gi,""),s}function U(s){const t=/(https?:\/\/(?:www\.)?(?:youtube\.com|youtu\.be)[^\s<)"']+)/g;return s=s.replace(t,(e,o,i,n)=>{const r=n.substring(Math.max(0,i-10),i);return/src=['"]$|href=['"]$|>$/.test(r)?e:`<a href="${e}" target="_blank" style="color:#2563eb; text-decoration:underline;">${e}</a>`}),s}function V(s){const t=s.split(`
`);let e=[],o=!1,i=0,n=0;for(let r of t){let a=r.trim();if(/^---+$/.test(a)){o&&(e.push("</ul>"),o=!1),i=0,n=0,e.push('<hr style="border:none; border-top:1px solid #e2e8f0; margin:12px 0;">');continue}if(/^### (.+)$/.test(a)){o&&(e.push("</ul>"),o=!1),i=0,n=0,e.push(`<div style="font-weight:700; font-size:15px; margin:12px 0 6px 0;">${a.replace(/^### /,"")}</div>`);continue}if(/^## (.+)$/.test(a)){o&&(e.push("</ul>"),o=!1),i=0,n=0,e.push(`<div style="font-weight:700; font-size:16px; margin:14px 0 6px 0;">${a.replace(/^## /,"")}</div>`);continue}if(/^[-*] (.+)$/.test(a)){n=0,o||(e.push("<ul>"),o=!0),e.push(`<li>${a.replace(/^[-*] /,"")}</li>`);continue}const p=a.match(/^(\d+)\.\s+(.+)$/);if(p){o&&(e.push("</ul>"),o=!1),i++,n=0;const d=p[1],f=p[2];e.push(`<div style="display:flex; gap:8px; margin:6px 0 2px 0;"><b style="min-width:20px; color:#1e40af;">${d}.</b><span>${f}</span></div>`);continue}o&&!/^[-*] /.test(a)&&(e.push("</ul>"),o=!1),a===""?(n++,n>=2&&(i=0),e.length>0&&e[e.length-1]!=="<br>"&&e.push("<br>")):(n=0,/^\*\*.+\*\*/.test(a)&&(i=0),i>0?a.startsWith("<br><a href=")||a.startsWith("<img")||a.includes("carmen-processed-video")?e.push(`<div style="margin:2px 0 8px 28px;">${a}</div>`):e.push(`<div style="margin:2px 0 6px 28px; color:#475569;">${a}</div>`):e.push(a+"<br>"))}return o&&e.push("</ul>"),e.join("")}function W(s){return s=s.replace(/`([^`]+)`/g,'<code style="background:#f1f5f9; padding:2px 6px; border-radius:4px; font-size:13px;">$1</code>'),s=s.replace(/\*\*(.*?)\*\*/g,"<b>$1</b>"),s=s.replace(new RegExp("(?<!\\*)\\*([^*]+)\\*(?!\\*)","g"),"<i>$1</i>"),s}function A(s,t){if(!s)return"";let e=String(s);const o=t?t.replace(/\/$/,""):"";return e=F(e),e=P(e,o),e=U(e),e=V(e),e=e.replace(/(<br>){3,}/g,"<br><br>"),e=W(e),e}const C={theme:"#34558b",title:"Carmen AI Specialist",showClearHistoryButton:!1,showAttachFileButton:!1,apiBase:""},J=["กดปุ่ม refresh ใน workbook ไม่ได้ ทำยังไง","บันทึกใบกำกับภาษีซื้อ ใน excel แล้ว import ได้หรือไม่","program carmen สามารถ upload file เข้า program RDPrep ของสรรพากรได้ หรือไม่","ฉันสามารถสร้าง ใบเสร็จรับเงิน โดยไม่เลือก Tax Invoice ได้หรือไม่","ฉันสามารถบันทึก JV โดยที่ debit และ credit ไม่เท่ากันได้หรือไม่"],g={error_missing_config:"❌ CarmenBot Error: กรุณาระบุ 'bu', 'user' และ 'apiBase' ใน Config ด้วยครับ (Required)",welcome_title:"สวัสดีค่ะ Carmen พร้อมช่วย!",welcome_desc:"สอบถามข้อมูลจากคู่มือบริษัท หรือเริ่มบทสนทนาใหม่ได้ทันทีด้านล่างนี้ค่ะ",history_loading:"⏳ กำลังโหลด...",alert_confirm:"ตกลง",alert_cancel:"ยกเลิก",delete_room_confirm_title:"ยืนยันลบห้องแชท?",delete_room_confirm_desc:"บทสนทนาที่เลือกจะถูกลบถาวร และไม่สามารถกู้คืนได้",clear_history_confirm_title:"ล้างประวัติห้องนี้?",clear_history_confirm_desc:"ข้อความในห้องนี้จะถูกลบทั้งหมด",file_too_large:"ไฟล์ใหญ่เกินไป",file_too_large_desc:"ไม่เกิน 5MB ครับ"};class q{constructor(t){this.bot=t,this.theme=t.theme,this.title=t.title||"Carmen AI Specialist",this.shadow=null}findElement(t){if(!this.shadow)return document.getElementById(t)||document.querySelector(t);if(!t.includes(" ")&&!t.includes(".")&&!t.startsWith("#")){const e=this.shadow.getElementById(t);return e||this.shadow.querySelector(`#${t}`)}return this.shadow.querySelector(t)}injectStyles(){if(this.shadow&&this.shadow.getElementById("carmen-style"))return;const t=document.createElement("link");t.href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Sarabun:wght@300;400;500;600&display=swap",t.rel="stylesheet",document.head.appendChild(t);const e=document.createElement("style");e.id="carmen-style",e.innerText=D(this.theme),this.shadow?this.shadow.appendChild(e):document.head.appendChild(e)}createDOM(){if(document.getElementById("carmen-chat-widget"))return;const t=document.createElement("div");t.id="carmen-chat-widget",Object.assign(t.style,{position:"fixed",bottom:"32px",right:"32px",zIndex:"2000000",width:"0",height:"0",display:"block",pointerEvents:"none"}),document.body.appendChild(t),this.shadow=t.attachShadow({mode:"open"}),this.shadow.innerHTML=z({showClear:this.bot.showClearHistoryButton,showAttach:this.bot.showAttachFileButton}),this.injectStyles();const e=this.findElement(".title-wrapper h3");e&&(e.textContent=this.title)}showWelcomeMessage(){const t=this.findElement("carmenChatBody");if(!t)return;t.innerHTML="";const e=document.createElement("div");e.className="welcome-hero";const o=g.welcome_title;e.innerHTML=`
            <div class="hero-icon">
            ...
            <p style="opacity: 0; transform: translateY(10px); transition: all 0.8s ease;" id="welcome-desc-text">${g.welcome_desc}</p>
        `,t.appendChild(e);const i=this.findElement("welcome-typing-title"),n=this.findElement("welcome-desc-text");let r=0;const a=()=>{r<o.length?(i.textContent+=o.charAt(r),r++,setTimeout(a,40)):n&&(n.style.opacity="1",n.style.transform="translateY(0)")};setTimeout(a,300),setTimeout(()=>this.addSuggestions(),1200)}showModal({title:t,text:e,icon:o="💡",confirmText:i=g.alert_confirm,cancelText:n=null,onConfirm:r=null}){const a=this.findElement("carmen-alert-overlay"),p=this.findElement("carmen-alert-icon"),d=this.findElement("carmen-alert-title"),f=this.findElement("carmen-alert-desc"),b=this.findElement("carmen-alert-actions");if(!a)return;if(p.innerHTML=o,d.textContent=t,f.innerHTML=e,b.innerHTML="",n){const l=document.createElement("button");l.className="btn-alert btn-cancel",l.textContent=n,l.onclick=()=>{a.style.display="none"},b.appendChild(l)}const m=document.createElement("button");m.className="btn-alert btn-confirm",m.textContent=i,m.onclick=()=>{a.style.display="none",r&&r()},b.appendChild(m),a.style.display="flex"}scrollToBottom(){const t=this.findElement("carmenChatBody");t&&(t.scrollTop=t.scrollHeight)}addMessage(t,e,o=null,i=null){const n=this.findElement("carmenChatBody");if(!n)return;const r=document.createElement("div");r.className=`msg ${e}`;const a=A(t||"",this.bot.apiBase),p=typeof I=="function"?I(e,o):"";r.innerHTML=a+p,n.appendChild(r),this.scrollToBottom(),e==="bot"&&this.bot.bindCopyEvent(r)}addStreamingMessage(){const t=this.findElement("carmenChatBody");if(!t)return{};const e=document.createElement("div");e.className="msg bot";const o=Date.now();return e.innerHTML=`
        ...
        `,t.appendChild(e),this.scrollToBottom(),{container:e,loader:e.querySelector(`#loading-${o}`),span:e.querySelector(`#streaming-content-${o}`)}}addSuggestions(t){this.shadow&&this.shadow.querySelectorAll(".suggestions-container").forEach(n=>n.remove());const e=t||this.bot.suggestedQuestions;if(!e||e.length===0)return;const o=this.findElement("carmenChatBody"),i=document.createElement("div");i.className="suggestions-container",e.forEach((n,r)=>{const a=document.createElement("button");a.innerText=n,a.className="suggestion-chip",a.style.animationDelay=`${r*.1}s`,a.onclick=()=>{this.bot.sendMessage(n),i.remove()},i.appendChild(a)}),o.appendChild(i),this.scrollToBottom()}clearImageSelection(){this.bot.currentImageBase64=null;const t=this.findElement("carmen-file-input");t&&(t.value="");const e=this.findElement("carmenImagePreview");e&&(e.style.display="none")}renderRoomList(t,e){const o=this.findElement("carmenRoomList");o&&(t&&t.length>0?(o.innerHTML="",t.forEach(i=>{const n=i.room_id===e,r=document.createElement("div");r.innerHTML=B(i,n),o.appendChild(r.firstElementChild)})):o.innerHTML='<div style="padding:16px; text-align:center; color:#64748b; font-size:13px;">ไม่มีประวัติการสนทนา</div>')}showTooltip(){if(localStorage.getItem(`carmen_tooltip_seen_${this.bot.bu}`))return;const e=document.getElementById("carmen-chat-widget"),o=document.createElement("div");o.className="chat-tooltip",o.id="carmen-tooltip",o.innerHTML=H(),this.shadow?this.shadow.appendChild(o):e.appendChild(o),setTimeout(()=>o.classList.add("show"),2e3);const i=this.findElement("carmen-tooltip-close"),n=this.findElement("carmen-launcher"),r=()=>{o.classList.remove("show"),setTimeout(()=>o.remove(),500),localStorage.setItem(`carmen_tooltip_seen_${this.bot.bu}`,"true")};i&&(i.onclick=a=>{a.stopPropagation(),r()}),o&&(o.onclick=()=>{n&&n.click(),r()}),n&&n.addEventListener("click",r)}setupGlobalFunctions(){window.carmenRate=async(t,e,o)=>{const i=o.parentElement;i.innerHTML=e===1?'<span style="font-size:11px; color:#16a34a;">ขอบคุณค่ะ ❤️</span>':'<span style="font-size:11px; color:#991b1b;">ขอบคุณค่ะ 🙏</span>',await this.bot.api.sendFeedback(t,e)}}bindCopyEvent(t){const e=t.querySelector(".copy-btn");if(!e)return;e.onclick=()=>{const i=t.querySelector(".msg-bubble span")||t.querySelector(".msg-bubble")||t,n=i.innerText||i.textContent,r=()=>{const a=e.innerHTML;e.innerHTML=w.check,setTimeout(()=>{e.innerHTML=a},2e3)};navigator.clipboard&&navigator.clipboard.writeText?navigator.clipboard.writeText(n).then(r).catch(()=>o(n,r)):o(n,r)};function o(i,n){const r=document.createElement("textarea");r.value=i,r.style.cssText="position:fixed;left:-9999px",document.body.appendChild(r),r.select();try{document.execCommand("copy"),n()}catch(a){console.error("Fallback copy failed",a)}document.body.removeChild(r)}}showLauncher(){const t=this.findElement("carmen-launcher");t&&(t.style.display="flex")}}class K{constructor(t){this.bot=t,this.api=t.api,this.roomKey="carmen_current_room",this.typingBuffer="",this.isTyping=!1}async createNewChat(){this.bot.currentRoomId&&await this.api.clearHistory(this.bot.currentRoomId),this.bot.currentRoomId=null,localStorage.removeItem(this.roomKey),this.bot.ui.showWelcomeMessage(),await this.loadRoomList()}async switchRoom(t){this.bot.currentRoomId!==t&&(this.bot.currentRoomId=t,localStorage.setItem(this.roomKey,t),await this.loadHistory(t),await this.loadRoomList())}async deleteChatRoom(t){this.bot.ui.showModal({icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg>',title:g.delete_room_confirm_title,text:g.delete_room_confirm_desc,confirmText:"ลบทิ้ง",cancelText:g.alert_cancel,onConfirm:async()=>{try{await this.api.deleteRoom(t),this.bot.currentRoomId===t?this.createNewChat():await this.loadRoomList()}catch(e){console.error("Delete Error:",e)}}})}async loadRoomList(){try{const t=await this.api.getRooms();this.bot.ui.renderRoomList(t,this.bot.currentRoomId)}catch(t){console.error("Room List Error:",t)}}async loadHistory(t){const e=this.bot.ui.findElement("carmenChatBody");if(e){e.children.length===0&&(e.innerHTML=`<div style="text-align:center; padding:20px; color:#94a3b8;">${g.history_loading}</div>`);try{const o=await this.api.getRoomHistory(t);e.innerHTML="",o.messages&&o.messages.length>0?(o.messages.forEach(i=>{this.bot.ui.addMessage(i.message,i.sender,i.id,i.sources)}),setTimeout(()=>this.bot.ui.scrollToBottom(),100)):this.bot.ui.showWelcomeMessage()}catch(o){console.warn("History Load Error:",o),this.createNewChat()}}}async sendMessage(t=null){const e=this.bot.ui.findElement("carmenUserInput"),o=t||e.value.trim();if(!o&&!this.bot.currentImageBase64)return;if(!this.bot.currentRoomId)try{const l=o.substring(0,30)+(o.length>30?"...":""),y=await this.api.createRoom(this.bot.bu,this.bot.username,l);this.bot.currentRoomId=y.room_id,localStorage.setItem(this.roomKey,this.bot.currentRoomId),await this.loadRoomList()}catch{this.bot.ui.addMessage("⚠️ สร้างห้องสนทนาไม่สำเร็จ","bot");return}let i=o;this.bot.currentImageBase64&&(i=`<img src="${this.bot.currentImageBase64}" style="max-width:100%; border-radius:8px; margin-bottom:5px;"><br>${o}`),this.bot.ui.addMessage(i,"user"),await this.api.saveMessage(this.bot.currentRoomId,{sender:"user",message:o,image:!!this.bot.currentImageBase64,timestamp:new Date().toISOString()}),e.value="";const n=this.bot.currentImageBase64;this.bot.ui.clearImageSelection(),this.bot.ui.shadow&&this.bot.ui.shadow.querySelectorAll(".suggestions-container").forEach(l=>l.remove());const r=this.bot.ui.addStreamingMessage();r.loader&&(r.loader.style.display="none");const a=R(),p=document.createElement("div");p.innerHTML=a;const d=p.firstElementChild;r.container.appendChild(d),this.bot.ui.scrollToBottom();let f="",b=null,m=null;try{const l=await this.api.getRoomHistory(this.bot.currentRoomId),y=l?l.messages:[],c=(await fetch(`${this.bot.apiBase}/api/chat/stream`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({text:o,image:n,bu:this.bot.bu,username:this.bot.username,room_id:this.bot.currentRoomId,prompt_extend:this.bot.prompt_extend,history:y})})).body.getReader(),h=new TextDecoder("utf-8");this.typingBuffer="";let u="",x=!0;const E=()=>{if(this.typingBuffer.length>0){x&&(d&&d.remove(),r.span&&(r.span.style.display="block"),x=!1);const v=this.typingBuffer.length>50?5:this.typingBuffer.length>10?2:1;u+=this.typingBuffer.substring(0,v),this.typingBuffer=this.typingBuffer.substring(v),r.span&&(r.span.innerHTML=A(u,this.bot.apiBase),this.bot.ui.scrollToBottom())}(this.isTyping||this.typingBuffer.length>0)&&requestAnimationFrame(()=>setTimeout(E,15))};for(this.isTyping=!0,E();;){const{done:v,value:_}=await c.read();if(v)break;const $=h.decode(_,{stream:!0}).split(`
`);for(const N of $)if(N.trim())try{const S=JSON.parse(N);S.type==="chunk"?(this.typingBuffer+=S.data,f+=S.data):S.type==="sources"?b=S.data:S.type==="done"&&(m=S.id,this.loadRoomList())}catch{}}if(this.isTyping=!1,r.loader&&r.loader.remove(),m&&r.container){const{createMessageExtras:v}=await Promise.resolve().then(()=>Y),_=v("bot",m,b);r.container.insertAdjacentHTML("beforeend",_),this.bot.bindCopyEvent(r.container),await this.api.saveMessage(this.bot.currentRoomId,{id:m,sender:"bot",message:f,sources:b,timestamp:new Date().toISOString()})}}catch(l){console.error("Stream Error:",l)}}}class G{constructor(t){this.bot=t,this.closeTimeout=null}attach(){const t=this.bot.ui.findElement("carmenChatWindow"),e=this.bot.ui.findElement("carmen-launcher"),o=this.bot.ui.findElement("carmen-close-btn"),i=this.bot.ui.findElement("carmen-expand-btn"),n=this.bot.ui.findElement("new-chat-btn"),r=this.bot.ui.findElement("carmenRoomList"),a=this.bot.ui.findElement("carmen-room-dropdown-btn"),p=this.bot.ui.findElement("carmenRoomDropdownMenu"),d=this.bot.ui.findElement(".chat-header");this.bot.ui.shadow&&this.bot.ui.shadow.addEventListener("click",c=>{p&&p.classList.contains("show")&&(c.target.closest("#carmenRoomDropdownContainer")||p.classList.remove("show"))});const f=()=>{t.classList.contains("closing")||(t.classList.add("closing"),p&&p.classList.remove("show"),localStorage.setItem(`carmen_open_${this.bot.bu}`,"false"),localStorage.setItem(`carmen_expanded_${this.bot.bu}`,"false"),this.closeTimeout=setTimeout(()=>{t.classList.remove("open","expanded","closing"),this.closeTimeout=null},800))};if(e&&(e.onclick=()=>{const c=t.classList.contains("open"),h=t.classList.contains("closing");c&&!h?f():(this.closeTimeout&&(clearTimeout(this.closeTimeout),this.closeTimeout=null),t.classList.remove("closing"),t.classList.add("open"),localStorage.setItem(`carmen_open_${this.bot.bu}`,"true"),p&&p.classList.remove("show"),setTimeout(()=>this.bot.ui.scrollToBottom(),100))}),d&&t){const c=localStorage.getItem(`carmen_chat_pos_${this.bot.bu}`);if(c)try{const h=JSON.parse(c);t.style.bottom=h.bottom,t.style.right=h.right}catch{}this._setupDraggable(d,t)}o&&(o.onclick=f),i&&(i.onclick=()=>{const c=!t.classList.contains("expanded");if(t.classList.add("resizing"),t.classList.toggle("expanded"),localStorage.setItem(`carmen_expanded_${this.bot.bu}`,c?"true":"false"),c)t.style.bottom="",t.style.right="";else{const h=localStorage.getItem(`carmen_chat_pos_${this.bot.bu}`);if(h)try{const u=JSON.parse(h);t.style.bottom=u.bottom,t.style.right=u.right}catch{}}!c&&p&&p.classList.remove("show"),setTimeout(()=>{t.classList.remove("resizing"),this.bot.ui.scrollToBottom()},600)}),n&&(n.onclick=()=>{p&&p.classList.remove("show"),this.bot.chat.createNewChat()}),a&&p&&(a.onclick=c=>{c.stopPropagation(),p.classList.toggle("show")}),r&&(r.onclick=async c=>{const h=c.target.closest(".delete-room-btn"),u=c.target.closest(".room-dropdown-item");if(h){c.stopPropagation();const x=h.getAttribute("data-id");this.bot.chat.deleteChatRoom(x);return}if(u){const x=u.getAttribute("data-id");this.bot.chat.switchRoom(x),p&&p.classList.remove("show")}},r.addEventListener("wheel",c=>{const h=c.deltaY>0,u=c.deltaY<0,x=r.scrollTop+r.clientHeight>=r.scrollHeight-1,E=r.scrollTop<=0;(h&&x||u&&E)&&c.preventDefault(),c.stopPropagation()},{passive:!1}));const b=this.bot.ui.findElement("carmen-clear-btn");b&&(b.onclick=()=>{this.bot.currentRoomId&&this.bot.ui.showModal({icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg>',title:g.clear_history_confirm_title,text:g.clear_history_confirm_desc,confirmText:"ลบเลย",cancelText:g.alert_cancel,onConfirm:async()=>{await this.bot.api.clearHistory(this.bot.bu,this.bot.username,this.bot.currentRoomId),await this.bot.chat.loadHistory(this.bot.currentRoomId)}})});const m=this.bot.ui.findElement("carmen-attach-btn");if(m){const c=this.bot.ui.findElement("carmen-file-input");m.onclick=()=>c.click(),c.onchange=h=>{const u=h.target.files[0];if(!u)return;if(u.size>5*1024*1024){this.bot.ui.showModal({icon:"⚠️",title:g.file_too_large,text:g.file_too_large_desc}),c.value="";return}const x=new FileReader;x.onload=E=>{this.bot.currentImageBase64=E.target.result;const v=this.bot.ui.findElement("carmenImagePreview"),_=this.bot.ui.findElement("preview-img-element");v&&_&&(_.src=this.bot.currentImageBase64,v.style.display="flex")},x.readAsDataURL(u)}}const l=this.bot.ui.findElement("clear-image-btn");l&&(l.onclick=()=>this.bot.ui.clearImageSelection());const y=this.bot.ui.findElement("carmen-send-btn"),k=this.bot.ui.findElement("carmenUserInput");y&&(y.onclick=()=>{this.bot.chat.sendMessage(),k&&(k.style.height="auto")}),k&&(k.addEventListener("input",function(){this.style.height="auto",this.style.height=this.scrollHeight+"px"}),k.addEventListener("keydown",c=>{c.key==="Enter"&&!c.shiftKey&&(c.preventDefault(),this.bot.chat.sendMessage(),k.style.height="auto")}))}_setupDraggable(t,e){let o=0,i=0,n=0,r=0,a=!1,p=null;const d=m=>{if(e.classList.contains("expanded"))return;const l=m.type.startsWith("touch")?m.touches[0]:m;o=l.clientX,i=l.clientY;const y=window.getComputedStyle(e);n=parseInt(y.bottom)||84,r=parseInt(y.right)||0,window.addEventListener("mousemove",f,{passive:!1}),window.addEventListener("mouseup",b),window.addEventListener("touchmove",f,{passive:!1}),window.addEventListener("touchend",b),a=!1,e.style.transition="none",document.body.style.userSelect="none",document.body.style.webkitUserSelect="none"},f=m=>{const l=m.type.startsWith("touch")?m.touches[0]:m,y=l.clientX,k=l.clientY;!a&&Math.abs(y-o)<5&&Math.abs(k-i)<5||(a||(a=!0,e.style.top="auto",e.style.left="auto"),m.cancelable&&m.preventDefault(),p&&cancelAnimationFrame(p),p=requestAnimationFrame(()=>{const c=o-y,h=i-k,u=n+h,x=r+c,E=e.getBoundingClientRect(),v=-22,_=window.innerHeight-E.height-42,j=-22,$=window.innerWidth-E.width-42;e.style.bottom=Math.min(Math.max(v,u),_)+"px",e.style.right=Math.min(Math.max(j,x),$)+"px"}))},b=()=>{window.removeEventListener("mousemove",f),window.removeEventListener("mouseup",b),window.removeEventListener("touchmove",f),window.removeEventListener("touchend",b),p&&cancelAnimationFrame(p),e.style.transition="",document.body.style.userSelect="",document.body.style.webkitUserSelect="",a&&localStorage.setItem(`carmen_chat_pos_${this.bot.bu}`,JSON.stringify({bottom:e.style.bottom,right:e.style.right}))};t.addEventListener("mousedown",d),t.addEventListener("touchstart",d,{passive:!0}),t.style.cursor="move"}}class L{constructor(t={}){if(Object.keys(t).length===0&&(t=this._getConfigFromScript()),!t.bu||!t.user||!t.apiBase){console.error(g.error_missing_config),t.isCustomElement||alert(g.error_missing_config);return}this.apiBase=(t.apiBase||C.apiBase).replace(/\/$/,""),this.bu=t.bu,this.username=t.user,this.theme=t.theme||C.theme,this.title=t.title||C.title,this.prompt_extend=t.prompt_extend||null,this.showClearHistoryButton=t.showClearHistoryButton??C.showClearHistoryButton,this.showAttachFileButton=t.showAttachFileButton??C.showAttachFileButton,this.suggestedQuestions=J,this.currentImageBase64=null,this.currentRoomId=null,localStorage.removeItem(`carmen_room_${this.bu}_${this.username}`),this.api=new T(this.apiBase),this.ui=new q(this),this.chat=new K(this),this.events=new G(this),this.init()}_getConfigFromScript(){const t=document.currentScript||document.querySelector('script[src*="carmen-widget.js"]');return t?{bu:t.getAttribute("data-bu"),user:t.getAttribute("data-user"),apiBase:t.getAttribute("data-api-base"),theme:t.getAttribute("data-theme"),title:t.getAttribute("data-title"),prompt_extend:t.getAttribute("data-prompt-extend")}:{}}async init(){this.ui.injectStyles(),this.ui.createDOM(),this.ui.setupGlobalFunctions(),this.events.attach(),this.ui.showLauncher(),await this.chat.loadRoomList(),this.ui.showWelcomeMessage(),this.ui.showTooltip(),this._restoreUIState()}_restoreUIState(){const t=localStorage.getItem(`carmen_open_${this.bu}`)==="true",e=localStorage.getItem(`carmen_expanded_${this.bu}`)==="true";if(t){const o=this.ui.findElement("carmenChatWindow");o&&o.classList.add("open")}if(e){const o=this.ui.findElement("carmenChatWindow");if(o){o.classList.add("expanded");const i=this.ui.findElement("carmenSidebar");i&&i.classList.add("sidebar-visible")}}}sendMessage(t){return this.chat.sendMessage(t)}bindCopyEvent(t){this.ui.bindCopyEvent(t)}}if(window.CarmenBot=L,"customElements"in window){class s extends HTMLElement{connectedCallback(){const e=this.getAttribute("bu"),o=this.getAttribute("user"),i=this.getAttribute("api-base");e&&o&&i&&new L({bu:e,user:o,apiBase:i,theme:this.getAttribute("theme"),title:this.getAttribute("title"),isCustomElement:!0})}}customElements.define("carmen-chatbot",s)}document.currentScript&&document.currentScript.hasAttribute("data-bu")&&new L,M.CarmenBot=L,Object.defineProperty(M,Symbol.toStringTag,{value:"Module"})}));
