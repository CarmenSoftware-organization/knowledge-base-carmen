...
ORDER = {
    ...
    # Settings folder order: Main, Procurement, Inventory, Portion,
    # Interface, Administration. Distinct weight ranges make the deployed
    # sidebar honor that order without relying on alphabetical folder names.
    "Settings/Main/7_8_Product_Category_Revised.md": 11,
    "Settings/Main/7_7_Product_Unit_Revised.md": 12,
    "Settings/Main/6_Product_Revised.md": 13,
    "Settings/Main/7_9_Location_Revised.md": 14,
    "Settings/Main/7_6_Currency_Revised.md": 15,
    "Settings/Procurement/Market List.md": 21,
    "Settings/Procurement/Standard Order.md": 22,
    "Settings/Procurement/Delivery Point.md": 23,
    "Settings/Procurement/Extra Cost Type.md": 24,
    "Settings/Inventory/Adjustment_Type_Revised.md": 31,
    "Settings/Inventory/Standard_Requisition_Revised.md": 32,
    "Settings/Portion/Portion_Category.md": 41,
    "Settings/Interface/Account Code Mapping.md": 51,
    "Settings/Administration/Department.md": 61,
    "Settings/Administration/Role.md": 62,
    "Settings/Administration/User.md": 63,
    "Settings/Administration/Workflow Management.md": 64,
}
